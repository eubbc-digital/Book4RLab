...
urlpatterns = [
    ...
    path('laboratory-contents/', views.LaboratoryContentList.as_view(), name='lab-content-list-create'),
    path('laboratory-contents/<int:pk>/', views.LaboratoryContentDetail.as_view(), name='lab-content-retrieve-update-destroy'),
